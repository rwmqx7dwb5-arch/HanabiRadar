...
/// the app (proving the integration builds and runs in the Simulator) and navigates to
/// the measurement screen. The real measurement / result / map / history screens are
